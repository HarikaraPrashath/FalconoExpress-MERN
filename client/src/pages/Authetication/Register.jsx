    ...
    <div className='flex min-h-screen items-center justify-center bg-gray-100 p-6 bg-gradient-to-r from-red-600 to-red-400'>
      <div className='w-full max-w-4xl flex bg-white rounded-2xl shadow-lg overflow-hidden'>
        ...
        <div className='w-full md:w-1/2 p-10 flex flex-col justify-center'>
          <h2 className='text-3xl font-bold text-gray-800 text-center mb-2'>Sign up in to Exclusive</h2>
          ...
          <div>
            ...
            <div>
              <label className='block text-gray-700 text-sm'>Email or Phone Number</label>
              <input
                type='text'
          ...
          <p className='mt-4 text-center text-gray-600'>
            Do you have an account? <a href='/login' className='text-red-500 hover:underline'>Sign In</a>
          </p>
        </div>
      </div>
    </div>
