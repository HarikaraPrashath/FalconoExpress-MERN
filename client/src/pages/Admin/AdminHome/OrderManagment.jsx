      ...
      <aside className="w-64 bg-gradient-to-b from-red-500 to-red-900 text-white p-6 flex flex-col justify-between shadow-lg">
        <div>
          ...
          <nav className="space-y-3">
            <Link
              to="/adminOrder"
              className="flex items-center space-x-3 p-3 bg-white text-red-600 rounded-lg shadow-md transition-all duration-200"
            >
            ...
            <Link
              to="/customerdelivery"
              className="flex items-center space-x-3 p-3 hover:bg-white hover:text-red-600 rounded-lg transition-all duration-200"
            >
            ...
            >
              ...
              <span className="font-medium">Revenue Info</span>
            </Link>
            <button
              onClick={logoutUser}
              className="flex items-center space-x-3 p-3 w-full text-left hover:bg-white hover:text-red-600 rounded-lg transition-all duration-200"
            >
