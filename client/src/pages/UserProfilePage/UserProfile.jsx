      ...
      <div className="w-64 bg-gradient-to-b from-red-500 to-red-900 text-white p-6 flex flex-col justify-between h-full">
        <div>
          ...
          <nav className="space-y-4">
            <button className="flex items-center space-x-2 w-full text-left p-2 hover:bg-white hover:text-red-600 rounded">
            ...
            <button onClick={logoutUser} className="flex items-center space-x-3 w-full text-left p-2 hover:bg-white hover:text-red-600 rounded">
          ...
          <table className="w-full border-collapse">
            ...
            <tbody>
              <tr className="border-b">
                <td className="p-3">
                  <img
                    src="https://images.pexels.com/photos/12456258/pexels-photo-12456258.jpeg"
                    alt="User"
